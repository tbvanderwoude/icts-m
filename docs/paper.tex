...
\begin{document}
	...
	\begin{wrapfigure}[21]{r}{.25\textwidth}
		...
		\end{minipage}
		\vspace{-10pt}
		\caption{Two types of conflict between agents from \cite{stern2019}.}\label{fig:conflicts}
	\end{wrapfigure}
	...
	With the multi-agent pathfinding problem defined, the matching extension of MAPF (MAPFM) that is the subject of this work can be described.
